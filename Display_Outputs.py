...
#
# # === إعداد التحويلات للصور مثل وقت التدريب ===
...
#
#
# # === Dataset مخصص يقرأ الصور من فولدر واحد فقط ===
...
#
# # ✋ عدل عدد الكلاسات هنا بنفس عدد الأشخاص اللي دربت عليهم
# NUM_CLASSES = 125
# model.fc = torch.nn.Linear(num_ftrs, NUM_CLASSES)
#
# # ✋ تأكد إن اسم الملف ده هو نفس اللي حفظته بعد التدريب
# model.load_state_dict(torch.load('face_recognition_model.pth', map_location=device))
# model = model.to(device)
# model.eval()
#
# # ✋ أسماء الكلاسات بالترتيب اللي تدربت عليه (من اسم الفولدرات وقت التدريب)
# class_names = [f"person_{i}" for i in range(NUM_CLASSES)]  # من 0 إلى 124
#
# # === تحميل الصور من test ===
...
# استخدم نفس البنية المستخدمة في التدريب
...
# أسماء الفئات الصحيحة (من 0 إلى 124)
